...
void main() {
  ...
  test(
    'localPagePath returns null for a page that is not downloaded',
    () async {
  ...
  test('keepRuleFor returns the manga keep-rule (off by default)', () async {
    await repo.db.upsertMangaMetadata(
      id: 5,
      title: 'M',
  ...
  test('deviceDownloadedCount counts only downloaded device copies', () async {
    ...
    await repo.db.setChapterDeviceState(
      1,
