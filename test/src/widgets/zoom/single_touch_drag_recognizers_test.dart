...
void main() {
  group('SingleTouchHorizontalDragGestureRecognizer', () {
    testWidgets('single-finger horizontal drag DOES trigger the end callback', (
      tester,
    ) async {
      var endCount = 0;
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          ...
          0,
          reason:
              'two-finger gesture must NOT be claimed by the '
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          ...
          1,
          reason:
              'a fresh single-finger drag must still fire — the '
